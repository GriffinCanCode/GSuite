...
ENV_REGISTRY = {
    ...
    "KEEP_APPS": {
        ...
        "default": "Google Chrome,Cursor,Terminal",
    },
    "DEBUG": {
        "required": False,
...
def create_default_env_file(env_path: str) -> None:
...
def validate_environment(env_path: str) -> List[str]:
...
def load_environment():
    ...
    env_path = os.path.join(script_dir, "internal", ".env")
